function Permisos({
  ...
  }, "Administra el acceso de pantalla y la edición administrativa por persona. Estos permisos no convierten una operación normal en una aprobación previa ni permiten editar saldos, históricos o confirmaciones directamente. En el repartidor, las capacidades de campo y Sincronización permanecen habilitadas; Productos, Inventario, Reportes, la exportación CSV y las pantallas administrativas están bloqueados. Los administradores siempre tienen acceso completo y no aparecen en esta lista."), err && React.createElement("div", {
    style: {
