...
function ConfiguracionMedicion({ currentUser = {}, medicion = null, tarifas = [] }) {
  ...
  return React.createElement('div', { className: 'fx-page-pricing', style: { padding: '16px 12px 30px', maxWidth: 760, margin: '0 auto' } },
    React.createElement('div', { className: 'fx-pricing-title', style: { fontSize: 22, fontWeight: 900, marginBottom: 4 } }, 'Medición'),
    React.createElement('div', { className: 'fx-pricing-intro', style: { color: 'var(--ink-soft)', fontSize: 12, lineHeight: 1.45, marginBottom: 14 } }, 'Unidad comercial, volumen y contador físico. Cada escala permanece separada.'),
...
function ConfiguracionTarifas({ currentUser = {}, tarifas = [] }) {
  ...
  return React.createElement('section', { className: 'fx-pricing-section fx-pricing-tariffs', style: { background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: 12, padding: 14, marginBottom: 12 } },
    React.createElement('div', { className: 'fx-pricing-section-heading', style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 8, marginBottom: 5 } }, React.createElement('h3', { style: { margin: 0 } }, 'Tarifas'), React.createElement('button', { type: 'button', onClick: nueva, style: { border: 0, borderRadius: 8, padding: '8px 10px', background: 'var(--accent)', color: 'var(--ink)', fontWeight: 800, fontSize: 11 } }, '+ Nueva tarifa')),
    React.createElement('div', { className: 'fx-pricing-helper', style: { color: 'var(--ink-soft)', fontSize: 11, lineHeight: 1.45, marginBottom: 10 } }, 'La tarifa define el precio. El medidor define el volumen.'),
