...
function ConfiguracionMedicion({ currentUser = {}, medicion = null, tarifas = [] }) {
  ...
  if (!esAdmin) return React.createElement('div', { style: { padding: 16, color: 'var(--ink-soft)' } }, 'Solo ADMIN puede configurar medición y venta.');
  ...
  return React.createElement('div', { style: { padding: '16px 12px 30px', maxWidth: 760, margin: '0 auto' } },
    React.createElement('div', { style: { fontSize: 22, fontWeight: 900, marginBottom: 4 } }, 'Medición y Venta'),
