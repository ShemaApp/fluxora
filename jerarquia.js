...
function JerarquiaPanel({ clientes = [], localidades = [], vehiculos = [], medidores = [], currentUser = {} }) {
  ...
  return React.createElement('div', { className: 'fx-page-hierarchy', style: { padding: '14px 12px 28px' } },
    ...
    React.createElement('input', { value: busqueda, onChange: e => setBusqueda(e.target.value), placeholder: 'Buscar cliente o localidad…', style: { width: '100%', boxSizing: 'border-box', padding: 11, borderRadius: 9, border: '1px solid var(--line-strong)', background: 'var(--surface)', color: 'var(--ink)', marginBottom: 8 } }),
