...
function JornadaMedidor({ localidades = [], jornadas = [], notas = [], clientes = [], cargasAgua = [], servicios = [], medicion = null, vehiculos = [], medidores = [], currentUser = {}, onIrA }) {
  ...
  return React.createElement('div', { className: 'fx-page-jornada', style: { padding: '16px 12px' } },
    ...
    jornadaAbierta ? React.createElement('div', { style: { background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: 12, padding: 14 } },
      ...
      React.createElement('div', { style: { background: 'var(--surface-2)', padding: 9, borderRadius: 8, fontSize: 12, marginBottom: 9 } }, 'Localidad asignada: ', form.localidadNombre || localidadActual?.nombre || 'Selecciona una localidad'),
      React.createElement('div', { style: { background: 'var(--surface-2)', padding: 9, borderRadius: 8, fontSize: 12, marginBottom: 9 } }, 'Vehículo asignado: ', form.vehiculoNombre || form.vehiculo || 'Selecciona una localidad'),
      React.createElement('div', { style: { background: 'var(--surface-2)', padding: 9, borderRadius: 8, fontSize: 12, marginBottom: 9 } }, 'Medidor asociado: ', form.medidorNombre || 'Selecciona una localidad'),
