...
const textoQRCliente = clienteId => 'CLIENTE:' + clienteId;
...
function FichaRapidaCliente({
  ...
  return React.createElement("div", {
    ...
    color: 'var(--ink-soft)'
  }, 'Sin crédito'), false && ubicacionValida ? React.createElement(Tag, {
    color: 'var(--ok-text)'
  ...
  }, historial.length))), false && React.createElement("div", null, React.createElement(Lbl, null, 'Contacto'), React.createElement("div", {
    style: {
      fontSize: 13,
      lineHeight: 1.45
    }
  ...
  }, '📍 ', cliente.localidad || cliente.domicilio || 'Localidad no registrada')), React.createElement("div", null, React.createElement(Lbl, null, 'Domicilio'), React.createElement("div", {
    style: {
      fontSize: 12,
      color: 'var(--ink-soft)'
    }
  }, cliente.domicilio || 'Domicilio no registrado')), React.createElement(Row, {
    style: {
      gap: 6,
      flexWrap: 'wrap'
    }
  ...
  }, cliente.tipo || 'Cliente fijo'), false && React.createElement(BOut, {
    onClick: onAbrirQR,
    style: {
      flex: 1
    }
...
function Clientes({
  ...
  const save = async () => {
    ...
    if (!identificacion) {
      alert('Captura el ID fijo único del cliente.');
      return;
    }
  ...
  return React.createElement("div", {
  ...
  }, "👥 Clientes"), puedeCrear && React.createElement(BFill, {
    onClick: () => setForm({
      identificacion: '',
      nombre: '',
      telefono: '',
    ...
    }, "📍 ", localidadDeCliente(c) || 'Sin clasificar')), false && React.createElement(MiniaturaQRCliente, {
      cliente: c,
      onClick: () => verQR(c)
    ...
    }, '⋮'))), false && !c.ubicacion && puedeEditar && React.createElement("div", {
    ...
    }, "📋 Historial"), false && React.createElement(BOut, {
      onClick: () => verQR(c),
      style: {
        flex: 1
      }
  ...
  }, React.createElement(Lbl, null, "ID fijo único"), React.createElement(Inp, {
  ...
  }, 'Selecciona una localidad existente o crea una nueva. El nombre se reutilizará en futuros clientes.'), React.createElement(Lbl, null, "La validación se realizará por lecturas físicas y conciliación de jornada"), React.createElement("div", {
    style: {
      marginBottom: 16
    }
  }, false && form.ubicacion ? React.createElement(Row, {
    style: {
      justifyContent: 'space-between',
