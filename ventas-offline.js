...
(function (global) {
  ...
  const construirNotaBase = (venta, fecha, items, incidencia, itemsAplicados, itemsFaltantes) => ({
    ...
    vehiculoNombre: venta.vehiculoNombre || venta.vehiculo || '',
  ...
  const conciliar = async venta => {
    ...
    return firestore.runTransaction(async tx => {
      ...
      if (venta.lecturaAntesVenta != null || venta.lecturaDespuesVenta != null) tx.set(firestore.collection('lecturas_medidor').doc(`${venta.id}-despacho`), {
        ...
        vehiculoId: venta.vehiculoId || '', vehiculoNombre: venta.vehiculoNombre || venta.vehiculo || '', medidorId: venta.medidorId || '', medidorNombre: venta.medidorNombre || '', medidorDigitos: venta.medidorDigitos, medidorLitrosPorIncremento: venta.medidorLitrosPorIncremento, clienteId: cliente.id, ventaId: venta.id, operacion: 'venta_agua_medidor'
      });
